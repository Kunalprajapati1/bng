...
// import React, { useState, useEffect } from 'react';
// import { StyleSheet, View, TouchableOpacity, searchText,ImageBackground, Text, Modal, TextInput, Dimensions, ScrollView, Alert } from 'react-native';
// import { Calendar } from 'react-native-calendars';
// import { useNavigation } from '@react-navigation/native';
...
//     <FlatList
//       style={{ flex: 1 }}
//       data={[{ key: '' }]} // Dummy data for rendering a single item
//       renderItem={() => ( // Render the content inside the FlatList
//         <View style={[styles.modalContent, { width }]}>
